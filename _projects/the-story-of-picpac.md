...
*The Story of PiCPAC* is a documentary produced by my friend Dom for their YouTube channel, [VideoDojo](https://www.youtube.com/@VideoDojoPro). In this video, they dive deep into the history of *PiCPAC*, an animatronic band created by *Namco* (yes, *that* Namco!) in the early 1980s.
...
<iframe class="video" src="https://www.youtube-nocookie.com/embed/lgoXhFGq9Y8?si=Crcsj6i2X5OkEj0W" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<div class="cluster">
<figure>
  <img src="/media/picpac_moodboard.webp">
  <figcaption>Promotional material for PiCPAC and screen printing techniques of the era provided key elements of the documentary's art direction.</figcaption>
</figure>

<figure>
  <img src="/media/picpac_exploration.webp">
  <figcaption>Style exploration for the presentation of photos, inspired by layouts found in magazines of the era.</figcaption>
</figure>
</div>
...
<figure>
  <img src="/media/picpac_specimen.webp">
  <figcaption>Palette, shapes, and illustrations. Did you know the shapes used as a background throughout the videos are based on the little emblems found on each band member? Now you do!</figcaption>
</figure>
