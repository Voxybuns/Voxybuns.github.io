...
<table class="wrapped">
  ...
  <tbody>
    ...
    <tr>
      <td label="Port name"><span>Destroy</span></td>
      <td label="Port function"><span>When a value other than 0.00 is received at this port, the object that the Nodon is connected to will be destroyed.<br />If nothing is connected to this port, an input value of 1.00 will be assumed.</span></td>
...
<p>All selected object types will be targeted for destruction.</p>
<table class="wrapped">
  <colgroup>
    <col />
    <col />
