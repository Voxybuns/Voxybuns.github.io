...
<table class="wrapped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td label="Port function"><span>Measures the sensor's movement speed along the x-axis and sends it as output. Measured in meters per second.</span></td>
      <td label="Output value"><span>Accepts any number</span></td>
    </tr>
    <tr>
      <td label="Port name"><span>Y</span></td>
      <td label="Port function"><span>Measures the sensor's movement speed along the y-axis and sends it as output. Measured in meters per second.</span></td>
      <td label="Output value"><span>Accepts any number</span></td>
    </tr>
    <tr>
      <td label="Port name"><span>Z</span></td>
      <td label="Port function"><span>Measures the sensor's movement speed along the z-axis and sends it as output. Measured in meters per second.</span></td>
      <td label="Output value"><span>Accepts any number</span></td>
    </tr>
  </tbody>
</table>
...
<table class="wrapped">
  ...
  <tbody>
    <tr>
      ...
      <td label="Description"><span>Outputs the speed based on the world's coordinate system.</span></td>
    </tr>
    <tr>
      <td label="Setting value"><span>Local</span></td>
      <td label="Description"><span>Outputs the speed of the sensor itself, based on the sensor's own coordinate system.</span></td>
    </tr>
    <tr>
      <td label="Setting value"><span>Camera</span></td>
      <td label="Description"><span>Outputs the speed based on the camera's coordinate system.</span></td>
    </tr>
  </tbody>
</table>
<h2>Size</h2>
