...
<div class="table-wrapper"><table><thead><tr><th>Setting value</th><th>Description</th></tr></thead><tbody><tr><td>World</td><td>Outputs the angle of rotation based the world's coordinate system.</td></tr><tr><td>Initial Angle</td><td>Outputs the angle of rotation based on the local coordinate system, relative to the initial angle.</td></tr><tr><td>Camera</td><td>Outputs the angle of rotation based on the camera's coordinate system.</td></tr></tbody></table></div>
