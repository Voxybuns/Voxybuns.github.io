---
title: Destroy-Object Nodon
layout: nodopedia/entry
category: object
quote: Hehehe...<br>Anything you need me to destroy?
---

# Port
## Input
<div class="table-wrapper"><table><thead><tr><th>Port name</th><th>Port function</th><th>Input operation</th></tr></thead><tbody><tr><td>Destroy</td><td>When a value other than 0.00 is received at this port, the object that the Nodon is connected to will be destroyed.<br>If nothing is connected to this port, an input value of 1.00 will be assumed.</td><td>Determines whether a signal is or is not equal to 0.00</td></tr></tbody></table></div>
